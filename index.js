...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.zgwvy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
// console.log(uri);
...
app.get('/', (req, res) => {
    res.send("Hello from doctors portal Running Server")
});
